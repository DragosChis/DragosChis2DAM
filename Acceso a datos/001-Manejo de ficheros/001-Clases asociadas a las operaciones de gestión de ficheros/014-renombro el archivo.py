...
for archivo in lista:  #Mediante bucle for recorremos la lista por cada archivo del directorio fotos
    ...
    cadena = datosexif[306].replace(":","-").replace(" ","_") #Reemplazamos los puntos por guillones
    print(cadena)
    os.rename('fotos/'+archivo,'fotos/'+cadena+".jpg") #Cambiamos el nombre de las imagenes por la fecha
